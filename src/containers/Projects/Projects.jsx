...
const Projects = () => {
  const allProjects = [
    ...
    {name: 'BiometricBites', description: 'Web application that allows biometric access to the university cafeteria with face recognition. The frontend is developed with ReactJS, the backend with Django.', img: images.biometricbites, website: '', github: 'https://github.com/AlessioLucciola/BiometricBites'},
    {name: 'Machine Leanning Model for Stroke Prediction', description: 'Homeworks for the master\'s degree in Computer Science course "Fundamentals of Data Science" at the University of Rome "La Sapienza" that consisted in creating a machine learning model for predicting strokes.', img: images.strokeprediction, website: '', github: 'https://github.com/AlessioLucciola/fundamentals-of-data-science'},
    {name: 'Q-Learning Routing Protocol for Drones', description: 'Homeworks for the master\'s degree in Computer Science course "Autonomous Networking" at the University of Rome "La Sapienza" that consisted in implementing a routing protocol for UAV ad-hoc wireless networks using Q-learning.', img: images.autonomousnetworking, website: '', github: 'https://github.com/AlessioLucciola/autonomous-networking'},
