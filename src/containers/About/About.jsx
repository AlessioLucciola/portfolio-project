          ...
          <div className='app__about-row'>
            ...
            <div className='app__about-column'>
              <p>I'm <span className='highlight-text'>Alessio Lucciola</span>, a {getAge()}-year-old <span className='highlight-text'>Software Engineer</span> from Italy.<br/>
                ...
                I'm particularly interested in developing <span className='highlight-text'>Web Applications</span> even though I'm always experimenting with new technologies and tools in order to come out with cool projects (especially if they concern <span className='highlight-text'>AI</span>).
              </p>
            </div>
          </div>
          <div className='app__about-row'>
